...
function declineboothforthisuser($postID){
     ...
     try{
        ...
        $result =  update_post_meta( $postID['postid'], 'boothStatus', 'Cancel' ); 
        $OrderUserID = get_post_meta( $postID['postid'], 'OrderUserID', true );
        
         $result =  update_post_meta( $postID['postid'], 'boothStatus', 'Declined' );
       
       
        contentmanagerlogging_file_upload ($lastInsertId,serialize('Declined request updated successfully'));
